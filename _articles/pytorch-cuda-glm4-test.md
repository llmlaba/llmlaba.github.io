---
layout: default
title: "GLM4 9B CUDA PyTorch Test"
date: 2026-01-11
categories: [llm, software]

images:
  - /assets/articles/general/GLM_4_logo.jpeg
  - /assets/articles/pytorch-cuda-glm4-test/1.jpg
  - /assets/articles/pytorch-cuda-glm4-test/2.jpg
---
> Date: {{ page.date | date: "%d.%m.%Y" }}  

# GLM4 9B CUDA PyTorch Test
...
```bash
mkdir -p ~/llm && cd ~/llm
python3 -m venv .venv_llm_glm4
source ./.venv_llm_glm4/bin/activate
python -m pip install --upgrade pip
pip install "torch==2.7.1" "torchvision==0.22.1" "torchaudio==2.7.1" --index-url https://download.pytorch.org/whl/cu128
pip install transformers accelerate
```
- Get the GLM4 9B model:

```bash
git lfs install
git clone https://huggingface.co/zai-org/GLM-4-9B-0414 glm4
```

- Create script test_cuda_glm4.py:
...
model_path = "/home/sysadmin/llm/glm4"
