---
layout: default
title: "Qwen 8B CUDA PyTorch Test"
date: 2026-01-13
categories: [llm, software]

images:
  - /assets/articles/general/qwen_logo.jpg
  - /assets/articles/pytorch-cuda-qwen3-test/1.jpg
  - /assets/articles/pytorch-cuda-qwen3-test/2.jpg
---
> Date: {{ page.date | date: "%d.%m.%Y" }}  

# Qwen 8B CUDA PyTorch Test 
...
```bash
mkdir -p ~/llm && cd ~/llm
python3 -m venv .venv_llm_qwen
source ./.venv_llm_qwen/bin/activate
python -m pip install --upgrade pip
pip install "torch==2.7.1" "torchvision==0.22.1" "torchaudio==2.7.1" --index-url https://download.pytorch.org/whl/cu128
pip install transformers accelerate
```
- Get the Qwen 8B model:

```bash
git lfs install
git clone https://huggingface.co/Qwen/Qwen3-8B-Base qwen
```

- Create script test_cuda_qwen.py:
...
model_path = "/home/sysadmin/llm/qwen"
